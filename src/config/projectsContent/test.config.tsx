...
export const TEST: ProjectContentConfig = {
	METADATA: {
	...
	previewInfo: {
		title: 'Strona testowa do testów',
		description:
			'Wszystko fajnie ale zobaczmy sobie czy to będzie poprawnie działać. Tego jeszcze nie robiłem nigdy ale przyszedł juz na to odpowiedni czas. ',
		mockupImg: '/img/portfolio/adona_mockup.webp',
		mockupAlt: 'Strona internetowa restauracji Adona',
		externalLink: 'http://www.adona.net.plasdasd',
		caseStudyLink: '/portfolio/adona321',
	},
};
