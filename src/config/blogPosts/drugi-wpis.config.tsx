...
const DESCRIPTION =
	'Warto dzielić się swoimi przemyśleniami w każdym zakresie i edukować się całe życie. Piękna i skuteczna nauka nigdy się nie kończy pod wartunkiem że wiesz gdzie zaczerpnąć informacji mordo. To jest jak wąchanie kleju - jak zaczniesz to już nie skończysz tak prędko. Warto dzielić się swoimi przemyśleniami w każdym zakresie i edukować się całe życie. Warto dzielić się swoimi przemyśleniami w każdym zakresie i edukować się całe życie. Piękna i skuteczna nauka nigdy się nie kończy pod wartunkiem że wiesz gdzie zaczerpnąć informacji mordo. To jest jak wąchanie kleju - jak zaczniesz to już nie skończysz tak prędko.';

export const DRUGI_WPIS: PostPageConfig = {
	metadata: {
		title: TITLE,
